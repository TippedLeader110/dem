...
?>
    <section id="menu">
       <div class="container">
        <h1 style="text-align: center; padding-top: 3%"><b>Berita Terkini</b></h1>
           <div class="card-group text-center p-5">
               <div class="row">
                    <div class="col-md-12 col-lg-4">
                        <div class="card m-3">
                            <img class="card-img-top mb-3" src="<?php echo base_url()?>assets/img/corona.jpg" alt="Card image cap">
                            <div class="card-block">
                                <h4 class="card-title">Update Corona</h4>
                                <p class="card-text p-3" style="text-align: justify;">Update Corona 2 April 2020 di Indonesia: jumlah kasus positif Covid-19 bertambah menjadi 1.790 pasien. Sedangkan jumlah kasus Covid-19 di seluruh dunia mendekati angka 1 juta.</p>
                                <!-- Large modal -->
                                <button class="btn btn-info mb-3" data-toggle="modal" data-target=".apps">Lihat Selengkapnya</button>
                                <div class="modal fade bd-example-modal-lg apps" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                  <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                      <h2 class="mn p-3">Update Corona</h2>
                                      <img class="card-img-top mb-3" src="<?php echo base_url()?>assets/img/corona.jpg" alt="Card image cap">
                                      <p class="mn p-4" style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Data kasus positif Covid-19 di Indonesia terus menunjukkan lonjakan jumlah pasien. Update data kasus infeksi virus corona di Indonesia pada hari ini kembali memperlihatkan penambahan jumlah pasien di atas 100 orang, meski dari segi angka lebih rendah dibandingkan peningkatan pada Rabu kemarin.<br>
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berdasarkan data yang diperbarui oleh Gugus Tugas Percepatan Penanganan Covid-19 pada pukul 15.40 WIB, Kamis, 2 April 2020, terdapat penambahan kasus positif baru sebanyak 113 pasien.<br> 
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Penambahan ini membuat total jumlah kasus positif Covid-19 di Indonesia menjadi 1.790 pasien. Sebanyak 1.508 pasien positif Covid-19 di tanah air saat ini sedang menjalani perawatan. Sementara jumlah pasien Covid-19 yang berhasil sembuh bertambah menjadi 112 orang. Namun, angka kasus kematian pasien positif Covid-19 di Indonesia juga meningkat menjadi 170 jiwa. <br>
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hingga hari ini, jumlah provinsi yang tercatat memiliki kasus positif Covid-19 masih sama dengan Rabu kemarin, yakni 32 daerah. DKI Jakarta yang menjadi episentrum utama kasus Covid-19 di Indonesia memiliki angka kasus terbanyak, yakni 897 pasien. Sejumlah 90 pasien positif Covid-19 di ibu kota sudah meninggal dan 52 orang lainnya berhasil sembuh. Di posisi kedua, ada Provinsi Jawa Barat yang kini telah memiliki 223 kasus positif Covid-19. Dari angka tersebut, 25 pasien meninggal dunia dan 21 lainnya sembuh.<br>
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kemudian, Provinsi Banten saat ini memiliki jumlah kasus terbanyak ketiga di Indonesia. Sebanyak 164 kasus positif Covid-19 telah ditemukan di Banten, dengan angka kasus kematian 14 jiwa dan 7 orang sembuh. Selanjutnya, Jawa Tengah dan Jawa Timur kini memiliki jumlah kasus positif Covid-19 yang sama, yakni masing-masing sebanyak 104 pasien. <br>
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Di Provinsi Jawa Tengah, tujuh pasien Covid-19 meninggal dan tujuh lainnya dinyatakan sembuh. Sedangkan angka kematian Jawa Timur mencapai 11 jiwa dan 22 pasien sembuh. Juru bicara pemerintah untuk penanganan Covid-19, Achmad Yurianto mengungkapkan aktivitas penyelidikan epidemiologi yang dilakukan melalui penelusuran kasus telah mengumpulkan 7.193 spesimen. "Yang harus kami lakukan tetap, yakni mencari dan mencari kasus positif di tengah masyarakat," kata Yurianto dalam konferensi pers pada Kamis sore, yang disiarkan BNPB. "Dengan penemuan kasus positif, kami bisa melakukan isolasi dan karantina [pasien] agar tidak terjadi penularan ke orang lain," tambah dia. (tirto.id)</p>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="card m-3">
                            <img class="card-img-top mb-3" src="<?php echo base_url()?>assets/img/2.jpg" alt="Card image cap">
                            <div class="card-block">
                                <h4 class="card-title">Data Corona di Dunia</h4>
                                <p class="card-text p-2" style="text-align: justify;">Jumlah kasus positif Covid-19 di dunia semakin mendekati angka 1 juta pasien. Direktur Jenderal WHO (Badan Kesehatan Dunia) Tedros Adhanom Ghebreyesus memprediksi angka kasus infeksi virus corona secara global akan menembus 1 juta dalam waktu dekat.</p>
                                <!-- Large modal -->
   ...
   <div id="about" class="container" style="border-top: 3px solid #008080;padding-bottom: 10%">
        <div class="starter-template">
            <br><br><h1 class="mb-5" style="text-align: center;"> <b>SEJARAH DEM INDONESIA</b></h1>
            <p style="text-align: justify;font-size: 20px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yogyakarta, Febuari 2018 Wega Maulana ketua Dewan Energi Mahasiswa UPN (DEM UPN) dan Rizki Nanda ketua Dewan Energi Mahasiswa UGM (DEM UGM) diskusi informal tentang kondisi energi di Indonesia pada zama dulu, sekarang dan yang akan datang. Indoensia dianugerahi kekayaan alam yang sangat melimpah, sumber daya manusia yang banyak, namun seberapa jauh sampai saat ini Indonesia mampu mengelolanya? Di bidang energi, sumber energi Indonesia sungguh melimpah. Panas matahari sungguh melimpah karena Indonesia terletak di katulistiwa,<span id="dots">...</span><span id="more" style="display: none;"> Tumbuh tumbuhan untuk dimanfaatkan menjadi energi biomassa melimpah, lautan dan sungai-sungai melimpah untuk dimanfaatkan menjadi Pembangkit listrik tenaga air, terletak di lingkar cincin api (ring of fire) sehingga mempunyai gunung2 yang didalamnya terdapat sumber energi panas bumi (geothermal). Kondisi Indonesia sangat memprihatinkan dengan ketahanan energi yang hanya 21 hari dan itupun tidak semua dikelola oleh putra bangsa sendiri, masih banyak dikelola oleh asing. Pasal 33 UUD 1945 berbunyi “bumi dan air dan kekayaan alam yang terkandung di dalamnya dikuasai oleh negara dan dipergunakan untuk sebesar-besarnya kemakmuran rakyat”. Dengan adanya SDA dan SDM yang melimpah ruah ini akhirnya Wega Maulana dan Rizki Nanda bercita-cita untuk nantinya mendirikan Dewan Energi Mahasiswa Indonesia untuk saling bersinergi kepada seluruh stakeholder yang terkait dengan penguatan energi Indonesia.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Waktu itu yang sudah berdiri hanya ada 2 DEM yaitu UPN dan UGM. DEM UGM berdiri tahun 2012 dan DEM UPN resmi berdiri tahun 2018. Awal mulanya DEM UGM berdiri untuk memberikan edukasi ke internal kampus UGM khususnya dan eksternal kampus UGM pada umumnya (Rizki Nanda pada tahun 2018), sedangkan DEM UPN berdiri khususnya untuk pengabdian masyarakat yaitu untuk mendekatkan masyarakat kepada sumber daya nya sehingga masyarakat nantinya bisa mengelola energi secara mandiri. (Wega Maulana pada tahun 2018). ketika nantinya DEM UGM dan DEM UGM dan Dewan Energi Mahasiswa yang tersebar diseluruh daerah Indonesia menggabungkan usahanya, Wega Maulana dan Rizki nanda membayangkan akan lebih cepat untuk menyebarkan kebermanfaatan masyarakat Indonesia di bidang energi. 
            <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Waktu terus berjalan, disusul DEM Indramayu, DEM Banyumas, DEM Universitas Riau, DEM Surabaya, DEM Banyuwangi dan muncul sampai sekitar 19 DEM seluruh Indonesia sampai tanggal 28 Oktober 2019 bertemu di Yogyakarta dalam Kongres Nasional DEM Indonesia pertama. DEM UPN menjadi penyelenggara Kongres Nasional tersebut. Alhasil ke 18 DEM yang ikut yaitu:<br>

            1. DEM UPN “V” Yogyakarta<br>
            2. DEM UGM<br>
            3. DEM INDRAMAYU <br>
            4. DEM BANYUMAS <br>
            5. DEM UNIVERSITAS RIAU <br>
            6. DEM SURABAYA <br>
            7. DEM BANYUWANGI <br> 
            8. DEM GRESIK <br>
            9. DEM TANGERANG <br>
            10. DEM PTAI JEMBER <br> 
            11. DEM SERANG RAYA <br>
            12. DEM SEMARANG <br>
            13. DEM UNDIP <br>
            14. DEM UNNES <br>
            15. DEM SULAWESI UTARA <br>
            16. DEM ACEH <br>
            17. DEM JEMBER<br>
            18. DEM MAKASSAR<br>
            19. DEM BANDUNG<br>

            Bersepakat untuk menggabungkan usaha nya bersama untuk Dewan Energi Mahasiswa Indonesia
          </span>
          <button onclick="myFunction()" id="myBtn" style="background-color: rgb(255, 255, 255,0.7);border-top:0; border-left:0;border-right:0;border-bottom: 0;"><i><u>Baca Selengkapnya>></u></i></button>
          <script>
            function myFunction() {
              ...
              if (dots.style.display === "none") {
                ...
                btnText.innerHTML = "<i><u>Baca Selengkapnya>></u></i>"; 
                moreText.style.display = "none";
              } else {
                dots.style.display = "none";
                btnText.innerHTML = "<i><u><< Baca lebih sedikit</u></i>"; 
    ...
    <section id="team" >
        <div class="container" style="background-color: #008080">
            <div class="row">
